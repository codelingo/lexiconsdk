...
export const renameNode = (n: Node): string => {
    switch (n.type) {
        ...
        case "JSXSpreadChild": return "jsx_spread_child";
        ...
        case "BooleanLiteral": return "bool_lit";
        case "NumericLiteral": return "numb_lit";
        case "StringLiteral": return "str_lit";
        case "NullLiteral": return "null_lit";
        case "RegExpLiteral": return "regexp_lit";
        case "SequenceExpression": return "seq_expr";
        ...
        case "TSAsExpression": return "as_expr";
        ...
        case "TSExpressionWithTypeArguments": return "expr_type_arg";
        ...
        case "TSAnyKeyword": return "any_kw";
        ...
        case "TSThisType": return "this_type";
